...
urlpatterns = [
    ...
    path('follow/<int:pk>/', FollowViewSet.as_view({'post': 'follow_user'}), name='follow_user'),
    path('unfollow/<int:pk>/', FollowViewSet.as_view({'post': 'unfollow_user'}), name='unfollow_user'),
