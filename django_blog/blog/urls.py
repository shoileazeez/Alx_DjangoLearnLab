...
from .views import register, profile, List_view,  Delete_view, Detail_View, create_view, Update_View, CommentCreateView, CommentUpdateView,CommentDeleteView,PostByTagListView
